 ...
 */
declare function simpleHardFold(str: string, opts: {
    lineLength: number;
    prefix?: string;
    suffix?: string;
    padNewLines?: boolean;
 ...
 */
declare function semanticLineFold(str: string, lineLength: number, afterSpace?: boolean): string;
/**
 ...
 */
declare function contentAppendWithFolding(content: string, appendParts: string[], lineLength: number): string;
