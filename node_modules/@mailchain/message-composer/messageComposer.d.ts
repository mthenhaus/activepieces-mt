...
import { Address, HeaderAttribute, Attachment } from './types.js';
 ...
 */
declare function createMessageComposer(customCtx?: MessageComposerContext): MessageComposer;

export { ComposedMessage, MessageComposer, createMessageComposer };
