"use strict";Object.defineProperty(exports, "__esModule", {value: true});// src/transport/serialization/serialization.ts
var MessageKind = /* @__PURE__ */ ((MessageKind2) => {
  MessageKind2[MessageKind2["UNSET"] = 0] = "UNSET";
  MessageKind2[MessageKind2["HEADER"] = 1] = "HEADER";
  MessageKind2[MessageKind2["CHUNK"] = 2] = "CHUNK";
  MessageKind2[MessageKind2["FINAL_CHUNK"] = 3] = "FINAL_CHUNK";
  return MessageKind2;
})(MessageKind || {});
var SIZE_VERSION = 1;
var SIZE_MESSAGE_KIND = 1;
var SIZE_MESSAGE_BYTES_SIZE = 4;
function serializeMessage(encryptedMessage, messageKind) {
  if (messageKind === 0 /* UNSET */) {
...
function serialize(input) {
  ...
  bufferCollector[0] = Buffer.from(new Uint8Array([1 /* V1_0_0 */]));
  let totalBufferOutSize = SIZE_VERSION;
  const serializedHeader = serializeMessage(input.EncryptedHeaders, 1 /* HEADER */);
  bufferCollector[1] = serializedHeader;
  totalBufferOutSize += serializedHeader.length;
  input.EncryptedContentChunks.forEach((c, i) => {
    const kind = input.EncryptedContentChunks.length === i + 1 ? 3 /* FINAL_CHUNK */ : 2 /* CHUNK */;
...
function deserialize(serializedData) {
  ...
  while (remainingBuffer.length > 0) {
    ...
    if (deserializedChunk.kind !== 2 /* CHUNK */ && deserializedChunk.kind !== 3 /* FINAL_CHUNK */) {
  ...
  if (deserializedChunks.length > 0 && lastMessageKind !== 3 /* FINAL_CHUNK */) {
...
exports.MessageKind = MessageKind; exports.serializeMessage = serializeMessage; exports.serialize = serialize; exports.deserializeMessage = deserializeMessage; exports.deserialize = deserialize;
