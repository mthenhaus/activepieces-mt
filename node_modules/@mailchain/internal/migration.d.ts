...
declare function nopMigration<T>(): MigrationRule<T>;
/** Combine multiple migration rules into a single, where only required migrations will be applied. */
declare function combineMigrations<T>(...migrations: MigrationRule<T>[]): MigrationRule<T>;

export { MigrationRule, combineMigrations, nopMigration };
