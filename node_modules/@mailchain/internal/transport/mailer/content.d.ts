...
import { MailAddress } from '../mail/types.js';
...
declare function createContentBuffer(content: MailerContent): string;
declare function parseMailerContentFromJSON(content: string): MailerContent;

export { MailerContent, createContentBuffer, parseMailerContentFromJSON };
