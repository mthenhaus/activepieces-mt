...
type ContentType = 'application/json' | 'message/x.mailchain' | 'message/x.mailchain-mailer' | 'application/vnd.mailchain.verified-credential-request';
/**
 * PayloadHeaders are the headers provide information about the payload.
 */
type PayloadHeaders<CT extends ContentType = ContentType> = {
    /**
...
export { ContentType, PayloadHeaders };
