"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }// src/mailboxRuleEngine/mailchainRuleRepository.ts
...
var MailchainRuleRepository = class {
  ...
  async addUserRule(params) {
    const id = _encoding.encodeBase64.call(void 0, _crypto.secureRandom.call(void 0, ));
  ...
  async getUserRules() {
    ...
    for (const storedUserRule of storedUserRules.values()) {
      ...
      rules.push({
        ...
        isEnabled: () => Promise.resolve(_nullishCoalesce(parsedRule.isEnabled, () => ( true))),
  ...
  async setEnabled(id, enabled) {
    ...
    return {
      ...
      isEnabled: () => Promise.resolve(_nullishCoalesce(updatedRule.isEnabled, () => ( true))),
...
exports.MailchainRuleRepository = MailchainRuleRepository;
