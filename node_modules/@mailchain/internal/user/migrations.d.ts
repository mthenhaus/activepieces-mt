...
type UserMailboxMigrationRule = MigrationRule<UserMailboxData>;
declare function createV2IdentityKey(identityKeys: IdentityKeys, mailchainAddressDomain: string): UserMailboxMigrationRule;
declare function createV3LabelMigration(_mailchainAddressDomain: string): UserMailboxMigrationRule;
declare function createV4AliasesMigration(mailchainAddressDomain: string): UserMailboxMigrationRule;
declare function createV5NsMigration(nameservices: Nameservices): UserMailboxMigrationRule;
declare function createV6FixNsAliasFormatMigration(mailchainAddressDomain: string): UserMailboxMigrationRule;

export { UserMailboxMigrationRule, createV2IdentityKey, createV3LabelMigration, createV4AliasesMigration, createV5NsMigration, createV6FixNsAliasFormatMigration };
