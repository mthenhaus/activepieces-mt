...
import { MailPreparer } from "@mailchain/internal/sending/mail";
...
import { PayloadDistributor } from "@mailchain/internal/sending";
var Mailchain = class {
  constructor(keyRing, config) {
    this.keyRing = keyRing;
    this.config = config;
    __publicField(this, "_userProfile");
    __publicField(this, "_mailboxOperations");
