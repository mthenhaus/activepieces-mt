import { ResolveAddressResult } from '@mailchain/internal/messagingKeys';
import { Configuration } from '@mailchain/internal/configuration';
 ...
 */
declare function resolveAddress(address: string, config?: Configuration): Promise<ResolveAddressResult>;
