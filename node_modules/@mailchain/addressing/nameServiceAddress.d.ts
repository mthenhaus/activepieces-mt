 ...
 */
declare function createNameServiceAddress(username: string, ...domainParts: [string, ...string[]]): NameServiceAddress;
declare function parseNameServiceAddress(address: string): NameServiceAddress;
declare function isNameServiceAddress(a: any): a is NameServiceAddress;

export { NameServiceAddress, createNameServiceAddress, isNameServiceAddress, parseNameServiceAddress };
