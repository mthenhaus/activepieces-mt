...
import {
  ...
  toFacade,
  version
} from "./chunk-XRNQSA2K.js";
import {
  gracefulDecodeURIComponent
} from "./chunk-T7USO5LJ.js";
import {
  ContextCancelation,
  CoreEventFactory,
  CoreEventQueue,
...
// ../../node_modules/@segment/analytics-next/dist/pkg/browser/index.js
function loadCDNSettings(writeKey, cdnURL) {
      ...
      switch (_j.label) {
        case 0:
          ...
          return [4, import(
            ...
            "./routing-middleware-JABWV7FD.js"
          ).then(function(mod) {
        ...
        case 6:
          ...
          return [4, import(
            ...
            "./legacy-video-plugins-5GGNB7LE.js"
          ).then(function(mod) {
        ...
        case 7:
          ...
          _j.label = 8;
        case 8:
          if (!((_a2 = options.plan) === null || _a2 === void 0 ? void 0 : _a2.track)) return [3, 10];
          return [4, import(
            /* webpackChunkName: "schemaFilter" */
            "./schema-filter-ICRMGJPJ.js"
          ).then(function(mod) {
            var _a3;
    ...
    return __generator(this, function(_m) {
      switch (_m.label) {
        case 0:
          ...
          if (!((_a2 = settings.cdnSettings) !== null && _a2 !== void 0)) return [3, 1];
          _l = _a2;
          return [3, 3];
        case 1:
          return [4, loadCDNSettings(settings.writeKey, settings.cdnURL)];
        case 2:
          _l = _m.sent();
          _m.label = 3;
        case 3:
        ...
        case 4:
          ...
          _m.label = 5;
        case 5:
          retryQueue = (_c = (_b2 = cdnSettings.integrations["Segment.io"]) === null || _b2 === void 0 ? void 0 : _b2.retryQueue) !== null && _c !== void 0 ? _c : true;
          options = __assign({ retryQueue }, options);
          analytics = new Analytics(__assign(__assign({}, settings), { cdnSettings }), options);
          ...
          return [4, registerPlugins(settings.writeKey, cdnSettings, analytics, options, plugins, classicIntegrations)];
        case 6:
          ctx = _m.sent();
          ...
          if (!term.includes("ajs_")) return [3, 8];
