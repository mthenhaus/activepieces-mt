...
export declare class DataExport {
    protected readonly _options: DataExport.Options;
    constructor(_options?: DataExport.Options);
    /**
     ...
     *     })
     */
    create(request: Intercom.CreateDataExportRequest, requestOptions?: DataExport.RequestOptions): Promise<Intercom.DataExport>;
    /**
     ...
     *     })
     */
    find(request: Intercom.FindDataExportRequest, requestOptions?: DataExport.RequestOptions): Promise<Intercom.DataExport>;
    /**
     ...
     *     })
     */
    cancel(request: Intercom.CancelDataExportRequest, requestOptions?: DataExport.RequestOptions): Promise<Intercom.DataExport>;
    /**
     ...
     *     })
     */
    download(request: Intercom.DownloadDataExportRequest, requestOptions?: DataExport.RequestOptions): Promise<void>;
