...
export declare class Tickets {
     ...
     *     })
     */
    reply(request: Intercom.ReplyToTicketRequest, requestOptions?: Tickets.RequestOptions): Promise<Intercom.TicketReply>;
    /**
     ...
     *     })
     */
    create(request: Intercom.CreateTicketRequest, requestOptions?: Tickets.RequestOptions): Promise<Intercom.Ticket>;
    /**
     ...
     *     })
     */
    get(request: Intercom.FindTicketRequest, requestOptions?: Tickets.RequestOptions): Promise<Intercom.Ticket>;
    /**
     ...
     *     })
     */
    update(request: Intercom.UpdateTicketRequest, requestOptions?: Tickets.RequestOptions): Promise<Intercom.Ticket>;
    /**
     ...
     *     })
     */
    search(request: Intercom.SearchRequest, requestOptions?: Tickets.RequestOptions): Promise<core.Page<Intercom.Ticket>>;
