    ...
    listItems(request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.IntercomTimeoutError("Timeout exceeded when calling GET /news/newsfeeds/{newsfeed_id}/items.");
                case "unknown":
                    throw new errors.IntercomError({
    ...
    find(request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.IntercomTimeoutError("Timeout exceeded when calling GET /news/newsfeeds/{newsfeed_id}.");
                case "unknown":
                    throw new errors.IntercomError({
                        message: _response.error.errorMessage,
                    });
