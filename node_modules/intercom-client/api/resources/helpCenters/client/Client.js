...
const Client_1 = require("../resources/collections/client/Client");
class HelpCenters {
    ...
    get collections() {
        var _a;
        return ((_a = this._collections) !== null && _a !== void 0 ? _a : (this._collections = new Client_1.Collections(this._options)));
    }
    /**
    ...
    find(request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.IntercomTimeoutError("Timeout exceeded when calling GET /help_center/help_centers/{help_center_id}.");
                case "unknown":
                    throw new errors.IntercomError({
...
exports.HelpCenters = HelpCenters;
